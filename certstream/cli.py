...
def main():
            ...
            if args.disable_colors:
                ...
                payload = "{} {} - {} {}\n".format(
                    termcolor.colored("[{}]".format(datetime.datetime.fromtimestamp(
                        message['data']['seen']).isoformat()), 'cyan', attrs=["bold", ]),
                    ...
                    termcolor.colored("[", 'blue') + "{}".format(
                        termcolor.colored(", ", 'blue').join(
                            [termcolor.colored(x, 'white', attrs=["bold", ])
                             for x in message['data']['leaf_cert']['all_domains']]
                        )
    ...
    listen_for_events(_handle_messages, skip_heartbeats=True)
